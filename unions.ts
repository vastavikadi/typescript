...
const user1: NormalUser | Admin = {//this is called union where user1 can either be NormalUser or A
...
function getUserId(id:number|string){
    ...
    if(typeof id ==="string"){//when you try to chamge the type here to number then again error at 25 this shows how brilliant ts is
        id.toUpperCase();
    }
    else{
        id.toPrecision();
